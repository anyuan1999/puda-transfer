...
def main(cfg):
    ...
    # Optimization: PositionalEncoder is deterministic and stateless across nodes;
    # constructing it once instead of per-node avoids a 100k x 200 sin/cos initialization
    # being repeated millions of times (was a major bottleneck on large datasets).
