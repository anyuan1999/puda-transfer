...
def main():
    ...
    parser.add_argument("--artifact_dir", default="/root/PIDSMaker/artifacts")
    parser.add_argument("--database_host", default="127.0.0.1")
    parser.add_argument("--database_port", type=str, default="5432")
    parser.add_argument("--database_user", default="pgsql")
    parser.add_argument("--database_password", default="")
